...
package com.netease.layoutconverter.tools.util;

import com.netease.layoutconverter.tools.processing.ScopedException;
...
public class L {
    ...
    public static void d(String msg, Object... args) {
        if (sEnableDebug) {
            printMessage(null, Kind.OTHER, String.format(msg, args));
        }
    }
    ...
    private static void printMessage(Element element, Kind kind, String message) {
    ...
    public interface Client {
        void printMessage(Kind kind, String message, Element element);
    }
